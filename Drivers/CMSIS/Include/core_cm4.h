 ...
 */
    ...
    #define __CM4_CMSIS_VERSION \
        ((__CM4_CMSIS_VERSION_MAIN << 16U) | __CM4_CMSIS_VERSION_SUB \
 ...
 */
        ...
        #define EXC_RETURN_HANDLER \
            (0xFFFFFFF1UL \
            ) /* return to Handler mode, uses MSP after return                               */
        #define EXC_RETURN_THREAD_MSP \
            (0xFFFFFFF9UL \
            ) /* return to Thread mode, uses MSP after return                                */
        #define EXC_RETURN_THREAD_PSP \
            (0xFFFFFFFDUL \
            ) /* return to Thread mode, uses PSP after return                                */
        #define EXC_RETURN_HANDLER_FPU \
            (0xFFFFFFE1UL \
            ) /* return to Handler mode, uses MSP after return, restore floating-point state */
        #define EXC_RETURN_THREAD_MSP_FPU \
            (0xFFFFFFE9UL \
            ) /* return to Thread mode, uses MSP after return, restore floating-point state  */
        #define EXC_RETURN_THREAD_PSP_FPU \
            (0xFFFFFFEDUL \
            ) /* return to Thread mode, uses PSP after return, restore floating-point state  */
