 ...
 */
    ...
    #define __CM35P_CMSIS_VERSION \
        ((__CM35P_CMSIS_VERSION_MAIN << 16U) | __CM35P_CMSIS_VERSION_SUB \
...
typedef struct {
    ...
    __IM uint32_t DEVTYPE; /*!< Offset: 0xFCC (R/ )  Device Type Identifier Register */
        ...
        #define TPI_ITFTTD0_ATB_IF2_ATVALID_Msk \
            (0x3UL << TPI_ITFTTD0_ATB_IF2_ATVALID_Pos \
        ...
        #define TPI_ITFTTD0_ATB_IF2_bytecount_Msk \
            (0x3UL << TPI_ITFTTD0_ATB_IF2_bytecount_Pos \
        ...
        #define TPI_ITFTTD0_ATB_IF1_ATVALID_Msk \
            (0x3UL << TPI_ITFTTD0_ATB_IF1_ATVALID_Pos \
        ...
        #define TPI_ITFTTD0_ATB_IF1_bytecount_Msk \
            (0x3UL << TPI_ITFTTD0_ATB_IF1_bytecount_Pos \
        ...
        #define TPI_ITFTTD0_ATB_IF1_data0_Msk \
            (0xFFUL /*<< TPI_ITFTTD0_ATB_IF1_data0_Pos*/ \
        ...
        #define TPI_ITFTTD1_ATB_IF2_ATVALID_Msk \
            (0x3UL << TPI_ITFTTD1_ATB_IF2_ATVALID_Pos \
        ...
        #define TPI_ITFTTD1_ATB_IF2_bytecount_Msk \
            (0x3UL << TPI_ITFTTD1_ATB_IF2_bytecount_Pos \
        ...
        #define TPI_ITFTTD1_ATB_IF1_bytecount_Msk \
            (0x3UL << TPI_ITFTTD1_ATB_IF1_bytecount_Pos \
        ...
        #define TPI_ITFTTD1_ATB_IF2_data2_Msk \
            (0xFFUL << TPI_ITFTTD1_ATB_IF2_data1_Pos \
        ...
        #define TPI_ITFTTD1_ATB_IF2_data0_Msk \
            (0xFFUL /*<< TPI_ITFTTD1_ATB_IF2_data0_Pos*/ \
...
typedef struct {
    ...
    __IM uint32_t MVFR1; /*!< Offset: 0x014 (R/ )  Media and FP Feature Register 1 */
        ...
        #define FPU_MVFR0_FP_excep_trapping_Msk \
            (0xFUL << FPU_MVFR0_FP_excep_trapping_Pos \
...
typedef struct {
    ...
    __IOM uint32_t DSCSR; /*!< Offset: 0x018 (R/W)  Debug Security Control and Status Register */
        ...
        #define CoreDebug_DAUTHCTRL_INTSPNIDEN_Msk \
            (1UL << CoreDebug_DAUTHCTRL_INTSPNIDEN_Pos \
        ...
        #define CoreDebug_DAUTHCTRL_SPIDENSEL_Msk \
            (1UL /*<< CoreDebug_DAUTHCTRL_SPIDENSEL_Pos*/ \
    ...
    /* Memory mapping of Core Hardware */
        ...
        #define FPU ((FPU_Type*)FPU_BASE) /*!< Floating Point Unit */
            ...
            #define SysTick_BASE_NS \
                (SCS_BASE_NS + 0x0010UL \
                ) /*!< SysTick Base Address              (non-secure address space) */
            #define NVIC_BASE_NS \
                (SCS_BASE_NS + 0x0100UL \
                ) /*!< NVIC Base Address                 (non-secure address space) */
            #define SCB_BASE_NS \
                (SCS_BASE_NS + 0x0D00UL \
                ) /*!< System Control Block Base Address (non-secure address space) */

            #define SCnSCB_NS \
                ((SCnSCB_Type*)SCS_BASE_NS \
                ) /*!< System control Register not in SCB(non-secure address space) */
            #define SCB_NS \
                ((SCB_Type*)SCB_BASE_NS \
                ) /*!< SCB configuration struct          (non-secure address space) */
            #define SysTick_NS \
                ((SysTick_Type*)SysTick_BASE_NS \
                ) /*!< SysTick configuration struct      (non-secure address space) */
            #define NVIC_NS \
                ((NVIC_Type*)NVIC_BASE_NS \
                ) /*!< NVIC configuration struct         (non-secure address space) */
            #define CoreDebug_NS \
                ((CoreDebug_Type*)CoreDebug_BASE_NS \
                ) /*!< Core Debug configuration struct   (non-secure address space) */

            #if defined(__MPU_PRESENT) && (__MPU_PRESENT == 1U)
                #define MPU_BASE_NS \
                    (SCS_BASE_NS + 0x0D90UL \
                    ) /*!< Memory Protection Unit            (non-secure address space) */
                #define MPU_NS \
                    ((MPU_Type*)MPU_BASE_NS \
                    ) /*!< Memory Protection Unit            (non-secure address space) */
            #endif

            #define FPU_BASE_NS \
                (SCS_BASE_NS + 0x0F30UL \
                ) /*!< Floating Point Unit               (non-secure address space) */
            #define FPU_NS \
                ((FPU_Type*)FPU_BASE_NS \
                ) /*!< Floating Point Unit               (non-secure address space) */
 ...
 */
        ...
        #define FNC_RETURN \
            (0xFEFFFFFFUL \
            ) /* bit [0] ignored when processing a branch                             */

        /* The following EXC_RETURN mask values are used to evaluate the LR on exception entry */
        #define EXC_RETURN_PREFIX \
            (0xFF000000UL \
            ) /* bits [31:24] set to indicate an EXC_RETURN value                     */
        #define EXC_RETURN_S \
            (0x00000040UL \
            ) /* bit [6] stack used to push registers: 0=Non-secure 1=Secure          */
        #define EXC_RETURN_DCRS \
            (0x00000020UL \
            ) /* bit [5] stacking rules for called registers: 0=skipped 1=saved       */
        #define EXC_RETURN_FTYPE \
            (0x00000010UL \
            ) /* bit [4] allocate stack for floating-point context: 0=done 1=skipped  */
        #define EXC_RETURN_MODE \
            (0x00000008UL \
            ) /* bit [3] processor mode for return: 0=Handler mode 1=Thread mode      */
        #define EXC_RETURN_SPSEL \
            (0x00000004UL \
            ) /* bit [2] stack pointer used to restore context: 0=MSP 1=PSP           */
        #define EXC_RETURN_ES \
            (0x00000001UL \
            ) /* bit [0] security state exception was taken to: 0=Non-secure 1=Secure */

        /* Integrity Signature (from ARMv8-M Architecture Reference Manual) for exception context stacking                            */
        #if defined(__FPU_PRESENT) \
            && (__FPU_PRESENT == 1U \
            ) /* Value for processors with floating-point extension:                  */
            #define EXC_INTEGRITY_SIGNATURE \
                (0xFEFA125AUL \
                ) /* bit [0] SFTC must match LR bit[4] EXC_RETURN_FTYPE                   */
        #else
            #define EXC_INTEGRITY_SIGNATURE \
                (0xFEFA125BUL \
                ) /* Value for processors without floating-point extension                */
        #endif
