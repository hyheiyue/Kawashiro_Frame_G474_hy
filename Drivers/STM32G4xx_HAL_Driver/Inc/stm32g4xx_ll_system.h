  ...
  */
    ...
    #define LL_DBGMCU_APB2_GRP1_TIM16_STOP \
        ...
        #define LL_DBGMCU_APB2_GRP1_TIM20_STOP \
            DBGMCU_APB2FZ_DBG_TIM20_STOP /*!< The counter clock of TIM20 is stopped when the core is halted*/
    #endif /* TIM20 */
    #if defined(HRTIM1)
        #define LL_DBGMCU_APB2_GRP1_HRTIM1_STOP \
            DBGMCU_APB2FZ_DBG_HRTIM1_STOP /*!< The counter clock of HRTIM1 is stopped when the core is halted*/
    #endif /* HRTIM1 */
    /**
  * @}
  */
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIT_FPU_IOC(void) {
    return (
        (READ_BIT(SYSCFG->CFGR1, SYSCFG_CFGR1_FPU_IE_0) == (SYSCFG_CFGR1_FPU_IE_0)) ? 1UL : 0UL
    );
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIT_FPU_DZC(void) {
    return (
        (READ_BIT(SYSCFG->CFGR1, SYSCFG_CFGR1_FPU_IE_1) == (SYSCFG_CFGR1_FPU_IE_1)) ? 1UL : 0UL
    );
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIT_FPU_UFC(void) {
    return (
        (READ_BIT(SYSCFG->CFGR1, SYSCFG_CFGR1_FPU_IE_2) == (SYSCFG_CFGR1_FPU_IE_2)) ? 1UL : 0UL
    );
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIT_FPU_OFC(void) {
    return (
        (READ_BIT(SYSCFG->CFGR1, SYSCFG_CFGR1_FPU_IE_3) == (SYSCFG_CFGR1_FPU_IE_3)) ? 1UL : 0UL
    );
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIT_FPU_IDC(void) {
    return (
        (READ_BIT(SYSCFG->CFGR1, SYSCFG_CFGR1_FPU_IE_4) == (SYSCFG_CFGR1_FPU_IE_4)) ? 1UL : 0UL
    );
}
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsEnabledIT_FPU_IXC(void) {
    return (
        (READ_BIT(SYSCFG->CFGR1, SYSCFG_CFGR1_FPU_IE_5) == (SYSCFG_CFGR1_FPU_IE_5)) ? 1UL : 0UL
    );
}
