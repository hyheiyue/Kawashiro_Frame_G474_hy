...
#include "stm32g4xx_hal_def.h"
  ...
  */
    ...
    #define DAC_LFSRUNMASK_BITS1_0 \
        (DAC_CR_MAMP1_0) /*!< Unmask DAC channel LFSR bit[1:0] for noise wave generation */
    #define DAC_LFSRUNMASK_BITS2_0 \
        (DAC_CR_MAMP1_1) /*!< Unmask DAC channel LFSR bit[2:0] for noise wave generation */
    ...
    #define DAC_LFSRUNMASK_BITS4_0 \
        (DAC_CR_MAMP1_2) /*!< Unmask DAC channel LFSR bit[4:0] for noise wave generation */
    ...
    #define DAC_LFSRUNMASK_BITS8_0 \
        (DAC_CR_MAMP1_3) /*!< Unmask DAC channel LFSR bit[8:0] for noise wave generation */
    ...
    #define DAC_TRIANGLEAMPLITUDE_1023 \
        (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_0) /*!< Select max triangle amplitude of 1023 */
    #define DAC_TRIANGLEAMPLITUDE_2047 \
        (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1) /*!< Select max triangle amplitude of 2047 */
  ...
  * @{
  */
    #define DAC_SAWTOOTH_POLARITY_DECREMENT \
  ...
  */
        ...
        #define IS_DAC_TRIGGER(DACX, TRIGGER) \
            (((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE) \
             ...
             || ((TRIGGER) == DAC_TRIGGER_EXT_IT9) || ((TRIGGER) == DAC_TRIGGER_T6_TRGO) \
             || ((TRIGGER) == DAC_TRIGGER_T3_TRGO) || ((TRIGGER) == DAC_TRIGGER_HRTIM_RST_TRG1) \
             ...
             || (((DACX) == DAC1) \
                 && (((TRIGGER) == DAC_TRIGGER_T8_TRGO) || ((TRIGGER) == DAC_TRIGGER_HRTIM_TRG01)) \
             ) \
             || (((DACX) == DAC2) \
                 && (((TRIGGER) == DAC_TRIGGER_T8_TRGO) || ((TRIGGER) == DAC_TRIGGER_HRTIM_TRG02)) \
             ) \
             || (((DACX) == DAC3) \
                 && (((TRIGGER) == DAC_TRIGGER_T1_TRGO) || ((TRIGGER) == DAC_TRIGGER_HRTIM_TRG03)) \
             ) \
             || (((DACX) == DAC4) \
                 && (((TRIGGER) == DAC_TRIGGER_T8_TRGO) || ((TRIGGER) == DAC_TRIGGER_HRTIM_TRG01)) \
             ))
        ...
        #define IS_DAC_TRIGGER(DACX, TRIGGER) \
            (((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE) \
             ...
             || (((DACX) == DAC3) ? ((TRIGGER) == DAC_TRIGGER_T1_TRGO) \
        ...
        #define IS_DAC_TRIGGER2(DACX, TRIGGER) \
            (((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE) \
             || ((TRIGGER) == DAC_TRIGGER_T7_TRGO) || ((TRIGGER) == DAC_TRIGGER_T15_TRGO) \
             || ((TRIGGER) == DAC_TRIGGER_T2_TRGO) || ((TRIGGER) == DAC_TRIGGER_T4_TRGO) \
             || ((TRIGGER) == DAC_TRIGGER_EXT_IT10) || ((TRIGGER) == DAC_TRIGGER_T6_TRGO) \
             || ((TRIGGER) == DAC_TRIGGER_T3_TRGO) || ((TRIGGER) == DAC_TRIGGER_HRTIM_STEP_TRG1) \
             ...
             || (((DACX) == DAC1) && ((TRIGGER) == DAC_TRIGGER_T8_TRGO)) \
             || (((DACX) == DAC2) && ((TRIGGER) == DAC_TRIGGER_T8_TRGO)) \
             || (((DACX) == DAC3) && ((TRIGGER) == DAC_TRIGGER_T1_TRGO)) \
             || (((DACX) == DAC4) && ((TRIGGER) == DAC_TRIGGER_T8_TRGO)))
    #else
        #define IS_DAC_TRIGGER2(DACX, TRIGGER) \
            (((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE) \
             || ((TRIGGER) == DAC_TRIGGER_T7_TRGO) || ((TRIGGER) == DAC_TRIGGER_T15_TRGO) \
    ...
    #define IS_DAC_CHIP_CONNECTION(CONNECT) \
        (((CONNECT) == DAC_CHIPCONNECT_EXTERNAL) || ((CONNECT) == DAC_CHIPCONNECT_INTERNAL) \
    ...
    #define IS_DAC_SAWTOOTH_POLARITY(POLARITY) \
        (((POLARITY) == DAC_SAWTOOTH_POLARITY_DECREMENT) \
...
HAL_StatusTypeDef
HAL_DACEx_TriangleWaveGenerate(DAC_HandleTypeDef* hdac, uint32_t Channel, uint32_t Amplitude);
HAL_StatusTypeDef
HAL_DACEx_NoiseWaveGenerate(DAC_HandleTypeDef* hdac, uint32_t Channel, uint32_t Amplitude);
HAL_StatusTypeDef HAL_DACEx_SawtoothWaveGenerate(
...
HAL_StatusTypeDef HAL_DACEx_DualStart_DMA(
    DAC_HandleTypeDef* hdac,
    uint32_t Channel,
...
HAL_StatusTypeDef
HAL_DACEx_DualSetValue(DAC_HandleTypeDef* hdac, uint32_t Alignment, uint32_t Data1, uint32_t Data2);
...
HAL_StatusTypeDef
HAL_DACEx_SelfCalibrate(DAC_HandleTypeDef* hdac, DAC_ChannelConfTypeDef* sConfig, uint32_t Channel);
