...
LL_LPUART_ConfigFIFOsThreshold(USART_TypeDef* LPUARTx, uint32_t TXThreshold, uint32_t RXThreshold) {
    ATOMIC_MODIFY_REG(
        LPUARTx->CR3,
...
/**
  ...
  */
__STATIC_INLINE void
LL_LPUART_SetTransferDirection(USART_TypeDef* LPUARTx, uint32_t TransferDirection) {
...
/**
  ...
  */
__STATIC_INLINE void
LL_LPUART_ConfigNodeAddress(USART_TypeDef* LPUARTx, uint32_t AddressLen, uint32_t NodeAddress) {
    MODIFY_REG(
        LPUARTx->CR2,
...
LL_LPUART_GetBaudRate(const USART_TypeDef* LPUARTx, uint32_t PeriphClk, uint32_t PrescalerValue) {
    uint32_t lpuartdiv;
    uint32_t brrresult;
...
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_RXNE_RXFNE(const USART_TypeDef* LPUARTx) {
    return (
        (READ_BIT(LPUARTx->CR1, USART_CR1_RXNEIE_RXFNEIE) == (USART_CR1_RXNEIE_RXFNEIE)) ? 1UL : 0UL
    );
}
...
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TXE_TXFNF(const USART_TypeDef* LPUARTx) {
    return (
        (READ_BIT(LPUARTx->CR1, USART_CR1_TXEIE_TXFNFIE) == (USART_CR1_TXEIE_TXFNFIE)) ? 1UL : 0UL
    );
}
