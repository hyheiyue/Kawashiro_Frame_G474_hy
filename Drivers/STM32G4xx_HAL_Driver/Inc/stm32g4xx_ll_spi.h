...
typedef struct {
  ...
  */
    #define LL_SPI_RX_FIFO_TH_HALF \
        0x00000000U /*!< RXNE event is generated if FIFO level is greater than or equal to 1/2 (16-bit) */
...
typedef struct {
  ...
  */
        ...
        #define LL_I2S_DATAFORMAT_32B \
            (SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATLEN_1 \
