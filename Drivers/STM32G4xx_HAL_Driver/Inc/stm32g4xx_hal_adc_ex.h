...
typedef struct {
    ...
    uint32_t
        InjectedOffsetSign; /*!< Define if the offset should be subtracted (negative sign) or added
                                                  ...
                                                  Note: This parameter must be modified when no conversion is on going
                                                        ...
                                                        launch a conversion). */
    FunctionalState
        InjectedOffsetSaturation; /*!< Define if the offset should be saturated upon under or over flow.
    ...
    uint32_t
        InjectedNbrOfConversion; /*!< Specifies the number of ranks that will be converted within the ADC group
                                               injected sequencer.
    ...
    FunctionalState
        InjectedDiscontinuousConvMode; /*!< Specifies whether the conversions sequence of ADC group injected
    ...
    FunctionalState
        AutoInjectedConv; /*!< Enables or disables the selected ADC group injected automatic conversion
                                               after regular one
                                               This parameter can be set to ENABLE or DISABLE.
    ...
    uint32_t
        ExternalTrigInjecConv; /*!< Selects the external event used to trigger the conversion start of
                                               injected group.
    ...
    FunctionalState
        InjecOversamplingMode; /*!< Specifies whether the oversampling feature is enabled or disabled.
                                                      This parameter can be set to ENABLE or DISABLE.
...
#define ADC_OFFSET_NONE \
    (ADC_OFFSET_4 + 1U) /*!< ADC offset disabled: no offset correction for the selected
                                     ADC channel */
#define ADC_OFFSET_1 \
    (LL_ADC_OFFSET_1) /*!< ADC offset number 1: ADC channel and offset level to which
                                     the offset programmed will be applied (independently of channel mapped
                                     on ADC group regular or group injected) */
#define ADC_OFFSET_2 \
    (LL_ADC_OFFSET_2) /*!< ADC offset number 2: ADC channel and offset level to which
                                     the offset programmed will be applied (independently of channel mapped
                                     on ADC group regular or group injected) */
#define ADC_OFFSET_3 \
    (LL_ADC_OFFSET_3) /*!< ADC offset number 3: ADC channel and offset level to which
                                     the offset programmed will be applied (independently of channel mapped
                                     on ADC group regular or group injected) */
#define ADC_OFFSET_4 \
    (LL_ADC_OFFSET_4) /*!< ADC offset number 4: ADC channel and offset level to which
                                     the offset programmed will be applied (independently of channel mapped
                                     on ADC group regular or group injected) */
/**
  * @}
...
/* Exported macros -----------------------------------------------------------*/
  ...
  */
    #define ADC_FORCE_MODE_INDEPENDENT(__HANDLE__) \
        LL_ADC_SetMultimode( \
            __LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance), \
...
#elif defined(STM32G411xB) || defined(STM32G414xx) || defined(STM32GBK1CB) || defined(STM32G431xx) \
    || defined(STM32G441xx) || defined(STM32G471xx)
...
/**
  ...
  */
    ...
    #define ADC_CLEAR_COMMON_CONTROL_REGISTER(__HANDLE__) \
        CLEAR_BIT( \
            __LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance)->CCR, \
            ADC_CCR_CKMODE | ADC_CCR_PRESC | ADC_CCR_VBATSEL | ADC_CCR_VSENSESEL | ADC_CCR_VREFEN \
                | ADC_CCR_MDMA | ADC_CCR_DMACFG | ADC_CCR_DELAY | ADC_CCR_DUAL \
        )
#endif /* ADC_MULTIMODE_SUPPORT */
...
#elif defined(STM32G411xB) || defined(STM32G411xC) || defined(STM32G414xx) || defined(STM32GBK1CB) \
  ...
  */
        ...
        ((((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) \
         ...
         || ((((__HANDLE__)->Instance) == ADC1) \
             && (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) \
                 || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP1) \
                 || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR_ADC1) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT)) \
         ) \
         || ((((__HANDLE__)->Instance) == ADC2) \
             && (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) \
                 || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_13) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP2) || ((__CHANNEL__) == ADC_CHANNEL_17) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC2))) \
         || ((((__HANDLE__)->Instance) == ADC3) \
             && (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) \
                 || ((__CHANNEL__) == ADC_CHANNEL_5) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC3) \
                 || ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))) \
         || ((((__HANDLE__)->Instance) == ADC4) \
             && (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) \
                 || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_13) \
                 || ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP6) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))) \
         || ((((__HANDLE__)->Instance) == ADC5) \
             && (((__CHANNEL__) == ADC_CHANNEL_VOPAMP5) \
                 || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR_ADC5) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP4) || ((__CHANNEL__) == ADC_CHANNEL_13) \
                 || ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))))
    ...
    #define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__) \
        ((((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) \
         ...
         || ((((__HANDLE__)->Instance) == ADC2) \
             && (((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP2) \
                 || ((__CHANNEL__) == ADC_CHANNEL_17) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC2))) \
         || ((((__HANDLE__)->Instance) == ADC3) \
             && (((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC3) || ((__CHANNEL__) == ADC_CHANNEL_16) \
                 || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT)) \
         ))
#elif defined(STM32G411xB) || defined(STM32G411xC) || defined(STM32G414xx) || defined(STM32GBK1CB) \
  ...
  */
    ...
    #define IS_ADC_DIFF_CHANNEL(__HANDLE__, __CHANNEL__) \
        ((((__CHANNEL__) == ADC_CHANNEL_1) \
          ...
          || ((((__HANDLE__)->Instance) == ADC2) \
              && (((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13))) \
          || ((((__HANDLE__)->Instance) == ADC3) && ((__CHANNEL__) == ADC_CHANNEL_15))))
#elif defined(STM32G411xB) || defined(STM32G414xx) || defined(STM32GBK1CB) || defined(STM32G431xx) \
    || defined(STM32G441xx)
    #define IS_ADC_DIFF_CHANNEL(__HANDLE__, __CHANNEL__) \
...
#if defined(ADC_MULTIMODE_SUPPORT)
HAL_StatusTypeDef
HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef* hadc, const ADC_MultiModeTypeDef* pMultimode);
#endif /* ADC_MULTIMODE_SUPPORT */
