...
typedef struct {
    ...
    uint32_t
        BreakAFMode; /*!< Specifies the alternate function mode of the break input.This parameter can be a value of @ref TIM_Break_Input_AF_Mode */
    ...
    uint32_t
        Break2AFMode; /*!< Specifies the alternate function mode of the break2 input.This parameter can be a value of @ref TIM_Break2_Input_AF_Mode */
...
typedef enum {
    ...
    ,
    HAL_TIM_ENCODER_INDEX_CB_ID =
        0x1CU /*!< TIM Encoder Index Callback ID                              */
    ,
    HAL_TIM_DIRECTION_CHANGE_CB_ID =
        0x1DU /*!< TIM Direction Change Callback ID                           */
    ,
    HAL_TIM_INDEX_ERROR_CB_ID =
        0x1EU /*!< TIM Index Error Callback ID                                */
    ,
...
#define TIM_OCMODE_COMBINED_PWM2 \
    (TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_0 | TIM_CCMR1_OC1M_2 \
    ) /*!< Combined PWM mode 2                    */
#define TIM_OCMODE_ASYMMETRIC_PWM1 \
    (TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1M_2 \
...
#define TIM_OCMODE_DIRECTION_OUTPUT \
    (TIM_CCMR2_OC3M_3 | TIM_CCMR2_OC3M_1 | TIM_CCMR2_OC3M_0 \
...
#define TIM_TS_ITR7 \
    (TIM_SMCR_TS_0 | TIM_SMCR_TS_1 | TIM_SMCR_TS_3) /*!< Internal Trigger 7 (ITR7)              */
#define TIM_TS_ITR8 (TIM_SMCR_TS_2 | TIM_SMCR_TS_3) /*!< Internal Trigger 8 (ITR8)              */
#if defined(TIM20)
    #define TIM_TS_ITR9 \
        (TIM_SMCR_TS_0 | TIM_SMCR_TS_2 | TIM_SMCR_TS_3 \
        ) /*!< Internal Trigger 9 (ITR9)              */
#endif /* TIM20 */
#define TIM_TS_ITR10 \
    (TIM_SMCR_TS_1 | TIM_SMCR_TS_2 | TIM_SMCR_TS_3) /*!< Internal Trigger 10 (ITR10)            */
#define TIM_TS_ITR11 \
    (TIM_SMCR_TS_0 | TIM_SMCR_TS_1 | TIM_SMCR_TS_2 | TIM_SMCR_TS_3 \
...
#define TIM_DMABURSTLENGTH_19TRANSFERS \
    0x00001200U /*!< The transfer is done to 19 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_20TRANSFERS \
    0x00001300U /*!< The transfer is done to 20 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_21TRANSFERS \
    0x00001400U /*!< The transfer is done to 21 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_22TRANSFERS \
    0x00001500U /*!< The transfer is done to 22 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_23TRANSFERS \
    0x00001600U /*!< The transfer is done to 23 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_24TRANSFERS \
    0x00001700U /*!< The transfer is done to 24 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_25TRANSFERS \
    0x00001800U /*!< The transfer is done to 25 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
#define TIM_DMABURSTLENGTH_26TRANSFERS \
    0x00001900U /*!< The transfer is done to 26 registers starting from TIMx_CR1 + TIMx_DCR.DBA */
/**
  * @}
  */
...
#define TIM_BREAK_SYSTEM_ECC \
    SYSCFG_CFGR2_ECCL /*!< Enables and locks the ECC error signal with Break Input of TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_PVD \
    SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/8/15/16/17/20 Break Input and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_SRAM_PARITY_ERROR \
    SYSCFG_CFGR2_SPL /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIM1/8/15/16/17/20 */
#define TIM_BREAK_SYSTEM_LOCKUP \
    SYSCFG_CFGR2_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of TIM1/8/15/16/17/20 */
/**
  * @}
  */
...
HAL_StatusTypeDef
HAL_TIM_Base_Start_DMA(TIM_HandleTypeDef* htim, const uint32_t* pData, uint16_t Length);
...
HAL_StatusTypeDef
HAL_TIM_SlaveConfigSynchro(TIM_HandleTypeDef* htim, const TIM_SlaveConfigTypeDef* sSlaveConfig);
HAL_StatusTypeDef
HAL_TIM_SlaveConfigSynchro_IT(TIM_HandleTypeDef* htim, const TIM_SlaveConfigTypeDef* sSlaveConfig);
