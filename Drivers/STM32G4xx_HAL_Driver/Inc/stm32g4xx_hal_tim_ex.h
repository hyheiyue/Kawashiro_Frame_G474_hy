...
typedef struct {
    uint32_t
        Polarity; /*!< TIM Encoder index polarity.This parameter can be a value of @ref TIMEx_Encoder_Index_Polarity */

    uint32_t
        Prescaler; /*!< TIM Encoder index prescaler.This parameter can be a value of @ref TIMEx_Encoder_Index_Prescaler */

    uint32_t
        Filter; /*!< TIM Encoder index filter.This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF */

    FunctionalState
        FirstIndexEnable; /*!< Specifies whether or not the encoder first index is enabled.This parameter value can be ENABLE or DISABLE. */

    uint32_t
        Position; /*!< Specifies in which AB input configuration the index event resets the counter.This parameter can be a value of @ref TIMEx_Encoder_Index_Position */

    uint32_t
        Direction; /*!< Specifies in which counter direction the index event resets the counter.This parameter can be a value of @ref TIMEx_Encoder_Index_Direction */
...
#define TIM_TIM1_ETR_ADC1_AWD3 \
    ...
    #define TIM_TIM1_ETR_ADC4_AWD1 \
        (TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0) /*!< ADC4 analog watchdog 1 */
    #define TIM_TIM1_ETR_ADC4_AWD2 \
        (TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2) /*!< ADC4 analog watchdog 2 */
    #define TIM_TIM1_ETR_ADC4_AWD3 \
        (TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0) /*!< ADC4 analog watchdog 3 */
#endif /* ADC4 */
...
#define TIM_TIM8_ETR_ADC2_AWD3 \
    ...
    #define TIM_TIM8_ETR_ADC3_AWD1 \
        (TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0) /*!< ADC3 analog watchdog 1 */
    #define TIM_TIM8_ETR_ADC3_AWD2 \
        (TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2) /*!< ADC3 analog watchdog 2 */
    #define TIM_TIM8_ETR_ADC3_AWD3 \
        (TIM1_AF1_ETRSEL_3 | TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0) /*!< ADC3 analog watchdog 3 */
#endif /* ADC3 */
...
#define TIM_TIM4_TI4_GPIO 0x00000000U /*!< TIM4 input 4 is connected to GPIO */
    ...
    #define TIM_TIM5_TI1_RTC_WK \
        (TIM_TISEL_TI1SEL_1 | TIM_TISEL_TI1SEL_0) /*!< TIM5 input 1 is connected to RTC_WAKEUP */
    ...
    #define TIM_TIM5_TI1_COMP4 \
        ...
        #define TIM_TIM5_TI1_COMP6 \
            (TIM_TISEL_TI1SEL_3 | TIM_TISEL_TI1SEL_0) /*!< TIM5 input 1 is connected to COMP6_OUT */
    #endif /* COMP6 */
    #if defined(COMP7)
        #define TIM_TIM5_TI1_COMP7 \
            (TIM_TISEL_TI1SEL_3 | TIM_TISEL_TI1SEL_1) /*!< TIM5 input 1 is connected to COMP7_OUT */
    #endif /* COMP7 */
    ...
    #define TIM_TIM5_TI2_COMP4 TIM_TISEL_TI2SEL_2 /*!< TIM5 input 2 is connected to COMP4_OUT */
        ...
        #define TIM_TIM5_TI2_COMP5 \
            (TIM_TISEL_TI2SEL_2 | TIM_TISEL_TI2SEL_0) /*!< TIM5 input 2 is connected to COMP5_OUT */
    #endif /* COMP5 */
    #if defined(COMP6)
        #define TIM_TIM5_TI2_COMP6 \
            (TIM_TISEL_TI2SEL_2 | TIM_TISEL_TI2SEL_1) /*!< TIM5 input 2 is connected to COMP6_OUT */
    #endif /* COMP6 */
    #if defined(COMP7)
...
#define TIM_TIM15_TI1_COMP2 \
    ...
    #define TIM_TIM15_TI1_COMP7 \
        (TIM_TISEL_TI1SEL_2 | TIM_TISEL_TI1SEL_0) /*!< TIM15 input 1 is connected to COMP7_OUT */
#endif /* COMP7 */
...
#define TIM_TIM15_TI2_COMP3 TIM_TISEL_TI2SEL_1 /*!< TIM15 input 2 is connected to COMP3_OUT */
    ...
    #define TIM_TIM15_TI2_COMP6 \
        (TIM_TISEL_TI2SEL_1 | TIM_TISEL_TI2SEL_0) /*!< TIM15 input 2 is connected to COMP6_OUT */
#endif /* COMP6 */
#if defined(COMP7)
...
#define TIM_TIM17_TI1_LSI \
    ...
    #define TIM_TIM20_TI1_COMP3 \
        (TIM_TISEL_TI1SEL_1 | TIM_TISEL_TI1SEL_0) /*!< TIM20 input 1 is connected to COMP3_OUT */
...
#define TIM_ENCODERINDEX_POSITION_0 \
    0x00000000U /*!< In directional clock mode or clock plus direction mode, index resets the counter when clock is 0 */
#define TIM_ENCODERINDEX_POSITION_1 \
    TIM_ECR_IPOS_0 /*!< In directional clock mode or clock plus direction mode, index resets the counter when clock is 1 */
/**
  * @}
  */
        ...
        ((((INSTANCE) == TIM1) \
         ...
         || (((INSTANCE) == TIM3) \
             && (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) \
                 ...
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_TI1ED) || ((__CLOCK__) == TIM_CLOCKSOURCE_TI1) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_TI2) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR0) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR1) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR3) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR4) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR5) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR6) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR7) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR8) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR9) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR10))) \
         ...
         || (((INSTANCE) == TIM5) \
             && (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) \
                 ...
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_TI2) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR0) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR1) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR2) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR3) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR5) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR6) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR7) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR8) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR9) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR10))) \
         || (((INSTANCE) == TIM8) \
             && (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) \
                 ...
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_TI2) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR0) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR1) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR2) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR3) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR4) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR6) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR7) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR8) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR9) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR10))) \
         || (((INSTANCE) == TIM15) \
             && (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) \
                 ...
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR1) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR2) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR3) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR4) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR5) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR7) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR8) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR9) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR10))) \
         || (((INSTANCE) == TIM20) \
             && (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) \
        ...
        ((((INSTANCE) == TIM1) \
         ...
         || (((INSTANCE) == TIM8) \
             && (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) \
                 ...
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_TI2) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR0) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR1) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR2) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR3) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR6) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR7) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR8) \
                 || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR9))) \
         || (((INSTANCE) == TIM15) \
             && (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) \
...
HAL_StatusTypeDef
HAL_TIMEx_HallSensor_Init(TIM_HandleTypeDef* htim, const TIM_HallSensor_InitTypeDef* sConfig);
...
HAL_StatusTypeDef
HAL_TIMEx_HallSensor_Start_DMA(TIM_HandleTypeDef* htim, uint32_t* pData, uint16_t Length);
...
HAL_StatusTypeDef
HAL_TIMEx_TISelection(TIM_HandleTypeDef* htim, uint32_t TISelection, uint32_t Channel);
...
HAL_StatusTypeDef
HAL_TIMEx_ConfigAsymmetricalDeadTime(TIM_HandleTypeDef* htim, uint32_t FallingDeadtime);
