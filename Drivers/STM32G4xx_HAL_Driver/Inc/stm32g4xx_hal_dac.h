...
typedef struct {
    ...
    FunctionalState
        DAC_DMADoubleDataMode; /*!< Specifies if DMA double data mode should be enabled or not for the selected channel.
                                              This parameter can be ENABLE or DISABLE */

    FunctionalState
        DAC_SignedFormat; /*!< Specifies if signed format should be used or not for the selected channel.
                                              This parameter can be ENABLE or DISABLE */
    ...
    uint32_t
        DAC_Trigger2; /*!< Specifies the external secondary trigger for the selected DAC channel.
                                              This parameter can be a value of @ref DAC_trigger_selection.
                                              Note: In case of sawtooth wave generation, this
                                              trigger corresponds to the step trigger.*/

    uint32_t
        DAC_OutputBuffer; /*!< Specifies whether the DAC channel output buffer is enabled or disabled.
                                               This parameter can be a value of @ref DAC_output_buffer */

    uint32_t
        DAC_ConnectOnChipPeripheral; /*!< Specifies whether the DAC output is connected or not to on chip peripheral.
...
typedef void (*pDAC_CallbackTypeDef)(DAC_HandleTypeDef* hdac);
  ...
  */
    #define DAC_TRIGGER_NONE \
        0x00000000UL /*!< DAC (all) conversion is automatic once the DAC_DHRxxxx register has been loaded, and not by external trigger */
    #define DAC_TRIGGER_SOFTWARE \
        (DAC_CR_TEN1) /*!< DAC (all) conversion started by software trigger for DAC channel */
    #define DAC_TRIGGER_T1_TRGO \
        (DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
    ...
    #define DAC_TRIGGER_T6_TRGO \
        (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC (all): TIM6 TRGO selected as external conversion trigger for DAC channel */
    #define DAC_TRIGGER_T3_TRGO \
        (DAC_CR_TSEL1_3 | DAC_CR_TEN1 \
        ) /*!< DAC (all): TIM3 TRGO selected as external conversion trigger for DAC channel */
    #define DAC_TRIGGER_HRTIM_RST_TRG1 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM RST TRIG 1 selected as external conversion trigger for DAC channel. Note: only to be used as reset (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_STEP_TRG1 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM STEP TRIG 1 selected as external conversion trigger for DAC channel. Note: only to be used as step (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_RST_TRG2 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM RST TRIG 2 selected as external conversion trigger for DAC channel. Note: only to be used as reset (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_STEP_TRG2 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM STEP TRIG 2 selected as external conversion trigger for DAC channel. Note: only to be used as step (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_RST_TRG3 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM RST TRIG 3 selected as external conversion trigger for DAC channel. Note: only to be used as reset (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_STEP_TRG3 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM STEP TRIG 3 selected as external conversion trigger for DAC channel. Note: only to be used as step (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_RST_TRG4 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM RST TRIG 4 selected as external conversion trigger for DAC channel. Note: only to be used as reset (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_STEP_TRG4 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM STEP TRIG 4 selected as external conversion trigger for DAC channel. Note: only to be used as step (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_RST_TRG5 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM RST TRIG 5 selected as external conversion trigger for DAC channel. Note: only to be used as reset (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_STEP_TRG5 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM STEP TRIG 5 selected as external conversion trigger for DAC channel. Note: only to be used as step (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_RST_TRG6 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM RST TRIG 6 selected as external conversion trigger for DAC channel. Note: only to be used as reset (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_STEP_TRG6 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TEN1 \
        ) /*!< DAC (all): HRTIM STEP TRIG 6 selected as external conversion trigger for DAC channel. Note: only to be used as step (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
    #define DAC_TRIGGER_HRTIM_TRG01 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
    ...
    #define DAC_TRIGGER_HRTIM_TRG03 \
        (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1 \
        ) /*!< DAC3: HRTIM TRIG OUT 1 selected as external conversion trigger for DAC channel. Note: only to be used as update or reset (sawtooth generation) trigger. On this STM32 series, parameter only available if HRTIM feature is supported (refer to device datasheet for supported features list) */
...
HAL_StatusTypeDef HAL_DAC_RegisterCallback(
    DAC_HandleTypeDef* hdac,
