...
#if defined(OPAMP1) || defined(OPAMP2) || defined(OPAMP3) || defined(OPAMP4) || defined(OPAMP5) \
    || defined(OPAMP6)
...
typedef struct {
    ...
    uint32_t
        FunctionalMode; /*!< Set OPAMP functional mode by setting internal connections: OPAMP operation in standalone, follower, ...
  ...
  */
    #define LL_OPAMP_MODE_STANDALONE \
        (0x00000000UL) /*!< OPAMP functional mode, OPAMP operation in standalone */
    #define LL_OPAMP_MODE_FOLLOWER \
        (OPAMP_CSR_VMSEL_1 | OPAMP_CSR_VMSEL_0 \
    ...
    #define LL_OPAMP_MODE_PGA_IO0 \
        (OPAMP_CSR_PGGAIN_4 | OPAMP_CSR_VMSEL_1 \
    ...
    #define LL_OPAMP_MODE_PGA_IO0_IO1_BIAS \
        (OPAMP_CSR_PGGAIN_4 | OPAMP_CSR_PGGAIN_3 | OPAMP_CSR_VMSEL_1 \
        ) /*!< In PGA mode, the inverting input is connected to VINM0
                                                                                                          - Input signal on VINM0, bias on VINPx: negative gain
                                                                                                          - Bias on VINM0, input signal on VINPx: positive gain
  ...
  */
    ...
    #define LL_OPAMP_PGA_GAIN_64_OR_MINUS_63 \
        (OPAMP_CSR_PGGAIN_2 | OPAMP_CSR_PGGAIN_0) /*!< OPAMP PGA gain 64 or -63 */
    /**
  * @}
  */
  ...
  */
    #define LL_OPAMP_INPUT_NONINVERT_IO0 \
        (0x00000000UL) /*!< OPAMP non inverting input connected to I/O VINP0
    ...
    #define LL_OPAMP_INPUT_NONINVERT_IO1 \
        OPAMP_CSR_VPSEL_0 /*!< OPAMP non inverting input connected to I/O VINP1
    ...
    #define LL_OPAMP_INPUT_NONINVERT_IO3 \
        OPAMP_CSR_VPSEL /*!< OPAMP non inverting input connected to I/O VINP3
                                                                        (PD14 for OPAMP2) */
    #define LL_OPAMP_INPUT_NONINVERT_DAC \
        OPAMP_CSR_VPSEL /*!< OPAMP non inverting input connected internally to DAC channel
  ...
  */
    #define LL_OPAMP_INPUT_INVERT_IO0 \
        (0x00000000UL) /*!< OPAMP inverting input connected to I/O VINM0
    ...
    #define LL_OPAMP_INPUT_INVERT_CONNECT_NO \
        OPAMP_CSR_VMSEL_1 /*!< OPAMP inverting input not externally connected (intended for OPAMP in mode follower or PGA with positive gain without bias).
  ...
  */
    #define LL_OPAMP_INPUT_NONINVERT_IO0_SEC \
        (0x00000000UL) /*!< OPAMP secondary non inverting input connected to I/O VINP0
                                                                           (PA1  for OPAMP1, PA7  for OPAMP2, PB0  for OPAMP3, PB13 for OPAMP4, PB14 for OPAMP5, PB12 for OPAMP6)
                                                                           Note: On this STM32 series, all OPAMPx are not available on all devices. Refer to device datasheet for more details */
    #define LL_OPAMP_INPUT_NONINVERT_IO1_SEC \
        OPAMP_TCMR_VPSSEL_0 /*!< OPAMP secondary non inverting input connected to I/O VINP1
                                                                           (PA3  for OPAMP1, PB14 for OPAMP2, PB13 for OPAMP3, PD11 for OPAMP4, PD12 for OPAMP5, PD9  for OPAMP6)
                                                                           Note: On this STM32 series, all OPAMPx are not available on all devices. Refer to device datasheet for more details */
    #define LL_OPAMP_INPUT_NONINVERT_IO2_SEC \
        OPAMP_TCMR_VPSSEL_1 /*!< OPAMP secondary non inverting input connected to I/O VINP2
                                                                           (PA7  for OPAMP1, PB0  for OPAMP2, PA1  for OPAMP3, PB11 for OPAMP4, PC3  for OPAMP5, PB13 for OPAMP6)
                                                                           Note: On this STM32 series, all OPAMPx are not available on all devices. Refer to device datasheet for more details */
    #define LL_OPAMP_INPUT_NONINVERT_IO3_SEC \
        OPAMP_TCMR_VPSSEL /*!< OPAMP secondary non inverting input connected to I/O VINP3
                                                                           (PD14 for OPAMP2) */
    #define LL_OPAMP_INPUT_NONINVERT_DAC_SEC \
        OPAMP_TCMR_VPSSEL /*!< OPAMP secondary non inverting input connected internally to DAC channel
                                                                           (DAC3_CH1 for OPAMP1, DAC3_CH2  for OPAMP3, DAC4_CH1 for OPAMP4, DAC4_CH2 for OPAMP5, DAC3_CH1 for OPAMP6)
                                                                           Note: On this STM32 series, all OPAMPx are not available on all devices. Refer to device datasheet for more details */
    /**
  * @}
  ...
  * @{
  */
    #define LL_OPAMP_INPUT_INVERT_IO0_SEC \
        (0x00000000UL \
        ) /*!< OPAMP secondary mode is standalone mode - Only applicable if @ref LL_OPAMP_MODE_STANDALONE
                                                                           ...
                                                                           (PA3  for OPAMP1, PA5  for OPAMP2, PB2  for OPAMP3, PB10 for OPAMP4, PB15 for OPAMP5, PA1  for OPAMP6)
                                                                           Note: On this STM32 series, all OPAMPx are not available on all devices. Refer to device datasheet for more details  */
    #define LL_OPAMP_INPUT_INVERT_IO1_SEC \
        OPAMP_TCMR_VMSSEL /*!< OPAMP secondary mode is standalone mode - Only applicable if @ref LL_OPAMP_MODE_STANDALONE
                                                                           has been configured by call to @ref LL_OPAMP_Init() or @ref LL_OPAMP_SetFunctionalMode().
                                                                           OPAMP secondary inverting input connected to I/0 VINM1
                                                                           (PC5  for OPAMP1, PC5  for OPAMP2, PB10 for OPAMP3, PB8  for OPAMP4, PA3  for OPAMP5, PB1  for OPAMP6)
                                                                           Note: On this STM32 series, all OPAMPx are not available on all devices. Refer to device datasheet for more details */
    #define LL_OPAMP_INPUT_INVERT_PGA_SEC \
        (0x00000000UL \
        ) /*!< OPAMP secondary mode is PGA mode - Only applicable if configured mode through call to @ref LL_OPAMP_Init()
    ...
    #define LL_OPAMP_INPUT_INVERT_FOLLOWER_SEC \
        OPAMP_TCMR_VMSSEL /*!< OPAMP secondary mode is Follower mode - Only applicable if configured mode through call to @ref LL_OPAMP_Init()
                                                                           or @ref LL_OPAMP_SetFunctionalMode() is NOT @ref LL_OPAMP_MODE_STANDALONE.
  ...
  * @{
  */
    #define LL_OPAMP_INTERNAL_OUPUT_DISABLED \
        (0x00000000UL) /*!< OPAMP internal output to ADC disabled. */
    #define LL_OPAMP_INTERNAL_OUPUT_ENABLED \
        OPAMP_CSR_OPAMPINTEN /*!< OPAMP internal output to ADC enabled.
  ...
  * @{
  */
    #define LL_OPAMP_INPUT_MUX_DISABLE \
        (0x00000000UL) /*!< OPAMP inputs timer controlled multiplexer mode disabled. */
    #define LL_OPAMP_INPUT_MUX_TIM1_CH6 \
        OPAMP_TCMR_T1CMEN /*!< OPAMP inputs timer controlled multiplexer mode enabled, controlled by TIM1 OC6. */
    #define LL_OPAMP_INPUT_MUX_TIM8_CH6 \
        OPAMP_TCMR_T8CMEN /*!< OPAMP inputs timer controlled multiplexer mode enabled, controlled by TIM8 OC6. */
    #define LL_OPAMP_INPUT_MUX_TIM20_CH6 \
        OPAMP_TCMR_T20CMEN /*!< OPAMP inputs timer controlled multiplexer mode enabled, controlled by TIM20 OC6.
  ...
  */
    ...
    #define LL_OPAMP_POWERMODE_HIGHSPEED \
        OPAMP_CSR_HIGHSPEEDEN /*!< OPAMP output in highspeed mode */

    #define LL_OPAMP_POWERMODE_NORMAL \
        LL_OPAMP_POWERMODE_NORMALSPEED /*!< OPAMP power mode normal - Old Naming for compatibility */
  ...
  */
    #define LL_OPAMP_TRIMMING_FACTORY \
        (0x00000000UL) /*!< OPAMP trimming factors set to factory values */
  ...
  */
    #define LL_OPAMP_TRIMMING_NMOS_VREF_90PC_VDDA \
        (OPAMP_CSR_TRIMOFFSETN | OPAMP_CSR_CALSEL_1 | OPAMP_CSR_CALSEL_0 \
        ) /*!< OPAMP trimming of transistors differential pair NMOS (internal reference voltage set to 0.9*Vdda). Default parameters to be used for calibration using two trimming steps (one with each transistors differential pair NMOS and PMOS). */
    #define LL_OPAMP_TRIMMING_NMOS_VREF_50PC_VDDA \
        (OPAMP_CSR_TRIMOFFSETN | OPAMP_CSR_CALSEL_1 \
        ) /*!< OPAMP trimming of transistors differential pair NMOS (internal reference voltage set to 0.5*Vdda). */
    #define LL_OPAMP_TRIMMING_PMOS_VREF_10PC_VDDA \
        (OPAMP_CSR_TRIMOFFSETP | OPAMP_CSR_CALSEL_0 \
        ) /*!< OPAMP trimming of transistors differential pair PMOS (internal reference voltage set to 0.1*Vdda). Default parameters to be used for calibration using two trimming steps (one with each transistors differential pair NMOS and PMOS). */
    #define LL_OPAMP_TRIMMING_PMOS_VREF_3_3PC_VDDA \
        (OPAMP_CSR_TRIMOFFSETP \
        ) /*!< OPAMP trimming of transistors differential pair PMOS (internal reference voltage set to 0.33*Vdda). */
...
__STATIC_INLINE void LL_OPAMP_SetFunctionalMode(OPAMP_TypeDef* OPAMPx, uint32_t FunctionalMode) {
    ...
    MODIFY_REG(
        OPAMPx->CSR,
        OPAMP_CSR_PGGAIN_4 | OPAMP_CSR_PGGAIN_3 | OPAMP_CSR_VMSEL | OPAMP_CSR_CALON,
        FunctionalMode
    );
}
...
__STATIC_INLINE uint32_t LL_OPAMP_GetFunctionalMode(OPAMP_TypeDef* OPAMPx) {
    return (uint32_t
    )(READ_BIT(OPAMPx->CSR, OPAMP_CSR_PGGAIN_4 | OPAMP_CSR_PGGAIN_3 | OPAMP_CSR_VMSEL));
}
...
__STATIC_INLINE uint32_t LL_OPAMP_GetPGAGain(OPAMP_TypeDef* OPAMPx) {
    return (uint32_t
    )(READ_BIT(OPAMPx->CSR, OPAMP_CSR_PGGAIN_2 | OPAMP_CSR_PGGAIN_1 | OPAMP_CSR_PGGAIN_0));
}
...
LL_OPAMP_SetInputNonInverting(OPAMP_TypeDef* OPAMPx, uint32_t InputNonInverting) {
...
/**
  ...
  */
__STATIC_INLINE void
LL_OPAMP_SetInputNonInvertingSecondary(OPAMP_TypeDef* OPAMPx, uint32_t InputNonInverting) {
...
__STATIC_INLINE void LL_OPAMP_SetInputsMuxMode(OPAMP_TypeDef* OPAMPx, uint32_t InputsMuxMode) {
    MODIFY_REG(
        OPAMPx->TCMR,
        OPAMP_TCMR_T1CMEN | OPAMP_TCMR_T8CMEN | OPAMP_TCMR_T20CMEN,
        InputsMuxMode
    );
}
...
__STATIC_INLINE uint32_t LL_OPAMP_GetInputsMuxMode(OPAMP_TypeDef* OPAMPx) {
    return (uint32_t
    )(READ_BIT(OPAMPx->TCMR, OPAMP_TCMR_T1CMEN | OPAMP_TCMR_T8CMEN | OPAMP_TCMR_T20CMEN));
}
...
/**
  ...
  */
__STATIC_INLINE void
LL_OPAMP_SetCalibrationSelection(OPAMP_TypeDef* OPAMPx, uint32_t TransistorsDiffPair) {
...
__STATIC_INLINE uint32_t LL_OPAMP_GetCalibrationSelection(OPAMP_TypeDef* OPAMPx) {
    ...
    return (
        ...
        | (((CalibrationSelection & OPAMP_CSR_CALSEL_1) == 0UL) ? OPAMP_CSR_TRIMOFFSETP
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_OPAMP_SetTrimmingValue(
    ...
    MODIFY_REG(
        ...
        TrimmingValue
            << ((TransistorsDiffPair == LL_OPAMP_TRIMMING_NMOS) ? OPAMP_CSR_TRIMOFFSETN_Pos
...
LL_OPAMP_GetTrimmingValue(OPAMP_TypeDef* OPAMPx, uint32_t TransistorsDiffPair) {
    return (uint32_t
    )(READ_BIT(OPAMPx->CSR, (TransistorsDiffPair & OPAMP_TRIMMING_VALUE_MASK))
      >> ((TransistorsDiffPair == LL_OPAMP_TRIMMING_NMOS) ? OPAMP_CSR_TRIMOFFSETN_Pos
                                                          : OPAMP_CSR_TRIMOFFSETP_Pos));
}
