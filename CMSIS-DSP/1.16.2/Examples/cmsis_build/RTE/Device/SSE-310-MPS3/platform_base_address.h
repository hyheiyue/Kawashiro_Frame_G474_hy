...
#define CORSTONE310_NSACFG_BASE_NS \
    0x40080000 /* Corstone-310 Non-Secure Access Configuration Register Block Non-Secure base address */
...
#define CORSTONE310_SYSINFO_BASE_NS \
    0x48020000 /* Corstone-310 System info Block Non-Secure base address */
#define SLOWCLK_TIMER_CMSDK_BASE_NS \
    0x4802F000 /* CMSDK based SLOWCLK Timer Non-Secure base address */
#define SYSWDOG_ARMV8_M_CNTRL_BASE_NS \
    0x48040000 /* Non-Secure Watchdog Timer control frame Non-Secure base address */
#define SYSWDOG_ARMV8_M_REFRESH_BASE_NS \
    0x48041000 /* Non-Secure Watchdog Timer refresh frame Non-Secure base address */
#define SYSCNTR_READ_BASE_NS 0x48101000 /* System Counter Read Secure base address */
/* Non-Secure MSTEXPPIHL Peripheral region */
#define U55_TIMING_ADAPTER_0_BASE_NS \
    0x48103000 /* Ethos-U55 Timing Adapter 0 APB registers Non-Secure base address */
#define U55_TIMING_ADAPTER_1_BASE_NS \
    0x48103200 /* Ethos-U55 Timing Adapter 1 APB registers Non-Secure base address */
#define FPGA_SBCon_I2C_TOUCH_BASE_NS \
    0x49200000 /* FPGA - SBCon I2C (Touch) Non-Secure base address */
#define FPGA_SBCon_I2C_AUDIO_BASE_NS \
    0x49201000 /* FPGA - SBCon I2C (Audio Conf) Non-Secure base address */
...
#define FPGA_DDR4_EEPROM_BASE_NS \
    0x49208000 /* FPGA - SBCon I2C (DDR4 EEPROM) Non-Secure base address */
...
#define CORSTONE310_SACFG_BASE_S \
    0x50080000 /* Corstone-310 Secure Access Configuration Register Secure base address */
#define MPC_ISRAM0_BASE_S \
    0x50083000 /* Internal SRAM0 Memory Protection Controller Secure base address */
#define MPC_ISRAM1_BASE_S \
    0x50084000 /* Internal SRAM1 Memory Protection Controller Secure base address */
...
#define CORSTONE310_SYSINFO_BASE_S \
    0x58020000 /* Corstone-310 System info Block Secure base address */
#define CORSTONE310_SYSCTRL_BASE_S \
    0x58021000 /* Corstone-310 System control Block Secure base address */
#define CORSTONE310_SYSPPU_BASE_S \
    0x58022000 /* Corstone-310 System Power Policy Unit Secure base address */
#define CORSTONE310_CPU0PPU_BASE_S \
    0x58023000 /* Corstone-310 CPU 0 Power Policy Unit Secure base address */
#define CORSTONE310_MGMTPPU_BASE_S \
    0x58028000 /* Corstone-310 Management Power Policy Unit Secure base address */
#define CORSTONE310_DBGPPU_BASE_S \
    0x58029000 /* Corstone-310 Debug Power Policy Unit Secure base address */
#define CORSTONE310_NPU0PPU_BASE_S \
    0x5802A000 /* Corstone-310 NPU 0 Power Policy Unit Secure base address */
...
#define SYSWDOG_ARMV8_M_CNTRL_BASE_S \
    0x58040000 /* Secure Watchdog Timer control frame Secure base address */
#define SYSWDOG_ARMV8_M_REFRESH_BASE_S \
    0x58041000 /* Secure Watchdog Timer refresh frame Secure base address */
...
#define U55_TIMING_ADAPTER_0_BASE_S \
    0x58103000 /* Ethos-U55 Timing Adapter 0 APB registers Secure base address */
#define U55_TIMING_ADAPTER_1_BASE_S \
    0x58103200 /* Ethos-U55 Timing Adapter 1 APB registers Secure base address */
#define FPGA_SBCon_I2C_TOUCH_BASE_S 0x59200000 /* FPGA - SBCon I2C (Touch) Secure base address */
#define FPGA_SBCon_I2C_AUDIO_BASE_S \
    0x59201000 /* FPGA - SBCon I2C (Audio Conf) Secure base address */
