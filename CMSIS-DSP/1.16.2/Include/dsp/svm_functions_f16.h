 ...
 */
void arm_svm_linear_init_f16(
    arm_svm_linear_instance_f16* S,
...
void arm_svm_polynomial_init_f16(
    arm_svm_polynomial_instance_f16* S,
    uint32_t nbOfSupportVectors,
    uint32_t vectorDimension,
    float16_t intercept,
    const float16_t* dualCoefficients,
 ...
 * @param[in]    gamma                  gamma (scikit-learn terminology)
 */
void arm_svm_rbf_init_f16(
    arm_svm_rbf_instance_f16* S,
    uint32_t nbOfSupportVectors,
    uint32_t vectorDimension,
    float16_t intercept,
    const float16_t* dualCoefficients,
 ...
 * @param[in]    gamma                  gamma (scikit-learn terminology)
 */
void arm_svm_sigmoid_init_f16(
    arm_svm_sigmoid_instance_f16* S,
    uint32_t nbOfSupportVectors,
    uint32_t vectorDimension,
    float16_t intercept,
    const float16_t* dualCoefficients,
