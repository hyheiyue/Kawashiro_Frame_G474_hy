...
void arm_bitonic_sort_f32(
    ...
    #define vrev128q_f32(a) vcombine_f32(vrev64_f32(vget_high_f32(a)), vrev64_f32(vget_low_f32(a)))

    #define vrev256q_f32(a) \
        do { \
            float32x4_t rev_tmp = vcombine_f32( \
                vrev64_f32(vget_high_f32(a.val[0])), \
                vrev64_f32(vget_low_f32(a.val[0])) \
            ); \
            a.val[0] = vcombine_f32( \
                vrev64_f32(vget_high_f32(a.val[1])), \
                vrev64_f32(vget_low_f32(a.val[1])) \
            ); \
            a.val[1] = rev_tmp; \
        } while (0)
