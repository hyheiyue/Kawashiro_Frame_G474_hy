...
ARM_DSP_ATTRIBUTE void arm_sin_cos_f32(float32_t theta, float32_t* pSinVal, float32_t* pCosVal) {
    ...
    Dn =
        0.0122718463030f; /* delta between the two points (fixed), in this case 2*pi/FAST_MATH_TABLE_SIZE */
