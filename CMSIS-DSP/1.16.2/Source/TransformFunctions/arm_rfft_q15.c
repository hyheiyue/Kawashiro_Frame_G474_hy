...
ARM_DSP_ATTRIBUTE void arm_rfft_q15(const arm_rfft_instance_q15* S, q15_t* pSrc, q15_t* pDst) {
...
ARM_DSP_ATTRIBUTE void arm_split_rfft_q15(
    ...
    const uint16_t offsetCoefArr[16] = { 0, 0, 2, 2, 4, 4, 6, 6, 0, 1, 0, 1, 0, 1, 0, 1 };
    ...
    while (i > 0U) {
        ...
        q15x8_t out = vhaddq_s16(
            MVE_CMPLX_MULT_FX_AxB(in1, coefA, q15x8_t),
...
ARM_DSP_ATTRIBUTE void arm_split_rifft_q15(
    ...
    while (i > 0U) {
        ...
        q15x8_t out = vhaddq_s16(
            MVE_CMPLX_MULT_FX_AxConjB(in1, coefA, q15x8_t),
