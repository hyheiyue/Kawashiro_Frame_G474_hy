...
static void
_arm_radix4_butterfly_q31_mve(const arm_cfft_instance_q31* S, q31_t* pSrc, uint32_t fftLen) {
    ...
    uint32_t stage = 0;
    int32_t iter = 1;
    static const int32_t strides[4] = { (0 - 16) * (int32_t)sizeof(q31_t*),
...
static void
arm_cfft_radix4by2_q31_mve(const arm_cfft_instance_q31* S, q31_t* pSrc, uint32_t fftLen) {
    uint32_t n2;
    q31_t* pIn0;
    q31_t* pIn1;
...
static void
arm_cfft_radix4by2_inverse_q31_mve(const arm_cfft_instance_q31* S, q31_t* pSrc, uint32_t fftLen) {
    uint32_t n2;
    q31_t* pIn0;
    q31_t* pIn1;
    const q31_t* pCoef = S->pTwiddle;
...
extern void
arm_bitreversal_32(uint32_t* pSrc, const uint16_t bitRevLen, const uint16_t* pBitRevTable);

ARM_DSP_ATTRIBUTE void arm_cfft_radix4by2_q31(q31_t* pSrc, uint32_t fftLen, const q31_t* pCoef);

ARM_DSP_ATTRIBUTE void
arm_cfft_radix4by2_inverse_q31(q31_t* pSrc, uint32_t fftLen, const q31_t* pCoef);
 ...
 */
ARM_DSP_ATTRIBUTE void
arm_cfft_q31(const arm_cfft_instance_q31* S, q31_t* p1, uint8_t ifftFlag, uint8_t bitReverseFlag) {
    uint32_t L = S->fftLen;
