...
static void
stage_rfft_f16(const arm_rfft_fast_instance_f16* S, const float16_t* p, float16_t* pOut) {
...
static void
merge_rfft_f16(const arm_rfft_fast_instance_f16* S, const float16_t* p, float16_t* pOut) {
    int32_t k; /* Loop Counter */
    float16_t twR, twI; /* RFFT Twiddle coefficients */
    const float16_t* pCoeff = S->pTwiddleRFFT; /* Points to RFFT Twiddle factors */
    const float16_t* pA = p; /* increasing pointer */
