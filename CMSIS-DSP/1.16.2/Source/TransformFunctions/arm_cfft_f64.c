...
extern void
arm_bitreversal_64(uint64_t* pSrc, const uint16_t bitRevLen, const uint16_t* pBitRevTable);
...
static void arm_cfft_radix4by2_f64(float64_t* pSrc, uint32_t fftLen, const float64_t* pCoef) {
    uint32_t i, l;
    uint32_t n2, ia;
