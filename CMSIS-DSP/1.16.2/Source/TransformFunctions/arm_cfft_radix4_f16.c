...
arm_cfft_radix4by2_f16(float16_t* pSrc, uint32_t fftLen, const float16_t* pCoef);
...
ARM_DSP_ATTRIBUTE void arm_cfft_radix4_f16(const arm_cfft_radix4_instance_f16* S, float16_t* pSrc) {
    if (S->ifftFlag == 1U) {
        /*  Complex IFFT radix-4  */
        arm_radix4_butterfly_inverse_f16(
            pSrc,
            S->fftLen,
            S->pTwiddle,
            S->twidCoefModifier,
...
ARM_DSP_ATTRIBUTE void arm_radix4_butterfly_f16(
    ...
    float16_t Xaplusc, Xbplusd, Yaplusc, Ybplusd, Xaminusc, Xbminusd, Yaminusc, Ybminusd;
    ...
    for (k = fftLen; k > 1U; k >>= 2U) {
        ...
        do {
            ...
            do {
                ...
                /* yc' = (ya-yb+yc-yd)co2 - (xa-xb+xc-xd)(si2) */
                pSrc[(2U * i1) + 1U] =
                    ((_Float16)s1 * (_Float16)co2) - ((_Float16)r1 * (_Float16)si2);
                ...
                /* yb' = (ya-xb-yc+xd)co1 - (xa+yb-xc-yd)(si1) */
                pSrc[(2U * i2) + 1U] =
                    ((_Float16)s1 * (_Float16)co1) - ((_Float16)r1 * (_Float16)si1);
                ...
                /* yd' = (ya+xb-yc-xd)co3 - (xa-yb-xc+yd)(si3) */
                pSrc[(2U * i3) + 1U] =
                    ((_Float16)s2 * (_Float16)co3) - ((_Float16)r2 * (_Float16)si3);
