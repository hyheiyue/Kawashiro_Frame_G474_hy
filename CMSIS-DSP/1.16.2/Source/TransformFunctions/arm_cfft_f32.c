...
static void
_arm_radix4_butterfly_f32_mve(const arm_cfft_instance_f32* S, float32_t* pSrc, uint32_t fftLen) {
...
static void
arm_cfft_radix4by2_f32_mve(const arm_cfft_instance_f32* S, float32_t* pSrc, uint32_t fftLen) {
...
static void _arm_radix4_butterfly_inverse_f32_mve(
...
static void arm_cfft_radix4by2_inverse_f32_mve(
    const arm_cfft_instance_f32* S,
    float32_t* pSrc,
    uint32_t fftLen
) {
...
ARM_DSP_ATTRIBUTE void arm_cfft_f32(
    ...
    if (ifftFlag == 1U) {
        switch (fftLen) {
            ...
            case 1024:
            case 4096:
                _arm_radix4_butterfly_inverse_f32_mve(
                    S,
                    pSrc,
                    fftLen,
