 ...
 */
ARM_DSP_ATTRIBUTE arm_status arm_cfft_init_f16(arm_cfft_instance_f16* S, uint16_t fftLen) {
    /*  Initialise the default arm status */
    arm_status status = ARM_MATH_SUCCESS;
