...
ARM_DSP_ATTRIBUTE void arm_rfft_q31(const arm_rfft_instance_q31* S, q31_t* pSrc, q31_t* pDst) {
...
ARM_DSP_ATTRIBUTE void arm_split_rfft_q31(
    ...
    while (i > 0U) {
        ...
        q31x4_t out = vhaddq_s32(
            MVE_CMPLX_MULT_FX_AxB(in1, coefA, q31x4_t),
...
ARM_DSP_ATTRIBUTE void arm_split_rifft_q31(
    ...
    while (i > 0U) {
        ...
        q31x4_t out = vhaddq_s32(
            MVE_CMPLX_MULT_FX_AxConjB(in1, coefA, q31x4_t),
