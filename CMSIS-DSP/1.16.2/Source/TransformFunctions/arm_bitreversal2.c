...
arm_bitreversal_64(uint64_t* pSrc, const uint16_t bitRevLen, const uint16_t* pBitRevTab) {
    uint64_t a, b, tmp;
    uint32_t i;
...
ARM_DSP_ATTRIBUTE void
arm_bitreversal_32(uint32_t* pSrc, const uint16_t bitRevLen, const uint16_t* pBitRevTab) {
    uint32_t a, b, i, tmp;
...
ARM_DSP_ATTRIBUTE void
arm_bitreversal_16(uint16_t* pSrc, const uint16_t bitRevLen, const uint16_t* pBitRevTab) {
    uint16_t a, b, tmp;
    uint32_t i;
