...
static void
_arm_radix4_butterfly_f16_mve(const arm_cfft_instance_f16* S, float16_t* pSrc, uint32_t fftLen) {
    ...
    uint32_t stage = 0;
    int32_t iter = 1;
    static const int32_t strides[4] = { (0 - 16) * (int32_t)sizeof(float16_t*),
...
static void
arm_cfft_radix4by2_f16_mve(const arm_cfft_instance_f16* S, float16_t* pSrc, uint32_t fftLen) {
...
static void _arm_radix4_butterfly_inverse_f16_mve(
...
static void arm_cfft_radix4by2_inverse_f16_mve(
    const arm_cfft_instance_f16* S,
    float16_t* pSrc,
    uint32_t fftLen
) {
...
ARM_DSP_ATTRIBUTE void arm_cfft_f16(
    ...
    if (ifftFlag == 1U) {
        switch (fftLen) {
            ...
            case 1024:
            case 4096:
                _arm_radix4_butterfly_inverse_f16_mve(
                    S,
                    pSrc,
                    fftLen,
...
extern void arm_cfft_radix4by2_f16(float16_t* pSrc, uint32_t fftLen, const float16_t* pCoef);
