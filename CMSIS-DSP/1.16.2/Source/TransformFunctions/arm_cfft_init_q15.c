...
#include "dsp/transform_functions.h"
    ...
    #define CFFT_RADIX4BY2_REARRANGE_TWIDDLES_Q15(LEN) \
        static arm_status arm_cfft_radix4by2_rearrange_twiddles_##LEN##_q15( \
            arm_cfft_instance_q15* S \
        ) { \
            S->rearranged_twiddle_tab_stride1_arr = \
                rearranged_twiddle_tab_stride1_arr_##LEN##_q15; \
            S->rearranged_twiddle_stride1 = rearranged_twiddle_stride1_##LEN##_q15; \
\
            S->rearranged_twiddle_tab_stride2_arr = \
                rearranged_twiddle_tab_stride2_arr_##LEN##_q15; \
            S->rearranged_twiddle_stride2 = rearranged_twiddle_stride2_##LEN##_q15; \
\
            S->rearranged_twiddle_tab_stride3_arr = \
                rearranged_twiddle_tab_stride3_arr_##LEN##_q15; \
...
CFFT_RADIX4BY2_REARRANGE_TWIDDLES_Q15(16);
    ...
    #define CFFTINIT_Q15(LEN, LENTWIDDLE) \
        ARM_DSP_ATTRIBUTE arm_status arm_cfft_init_##LEN##_q15(arm_cfft_instance_q15* S) { \
 ...
 */
ARM_DSP_ATTRIBUTE arm_status arm_cfft_init_q15(arm_cfft_instance_q15* S, uint16_t fftLen) {
    /*  Initialise the default arm status */
    arm_status status = ARM_MATH_SUCCESS;
