...
static void
arm_small_blk_max_q7(const q7_t* pSrc, uint16_t blockSize, q7_t* pResult, uint32_t* pIndex) {
...
arm_max_q7(const q7_t* pSrc, uint32_t blockSize, q7_t* pResult, uint32_t* pIndex) {
