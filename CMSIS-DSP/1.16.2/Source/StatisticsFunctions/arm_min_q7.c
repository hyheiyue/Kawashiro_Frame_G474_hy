...
static void
arm_small_blk_min_q7(const q7_t* pSrc, uint8_t blockSize, q7_t* pResult, uint32_t* pIndex) {
...
arm_min_q7(const q7_t* pSrc, uint32_t blockSize, q7_t* pResult, uint32_t* pIndex) {
