...
#if (defined(ARM_MATH_MVEF) || defined(ARM_MATH_HELIUM) || defined(ARM_MATH_NEON) || defined(ARM_MATH_NEON_EXPERIMENTAL)) \
 ...
 */
ARM_DSP_ATTRIBUTE void arm_vexp_f32(const float32_t* pSrc, float32_t* pDst, uint32_t blockSize) {
    uint32_t blkCnt;
