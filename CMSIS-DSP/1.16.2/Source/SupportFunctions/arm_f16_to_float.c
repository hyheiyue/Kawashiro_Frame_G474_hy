 ...
 */
        ...
        && defined(ARM_DSP_BUILT_WITH_GCC)
        #pragma GCC warning \
            "Scalar version of arm_f16_to_float built. Helium version has build issues with gcc."
    #endif
...
arm_f16_to_float(const float16_t* pSrc, float32_t* pDst, uint32_t blockSize) {
