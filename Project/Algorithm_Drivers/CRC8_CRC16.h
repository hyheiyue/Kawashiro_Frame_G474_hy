...
/**
  ...
  */
extern uint8_t
get_CRC8_check_sum(unsigned char* pchMessage, unsigned int dwLength, unsigned char ucCRC8);
...
uint16_t crc_ccitt_byte(uint16_t crc, uint8_t c);
uint16_t crc_ccitt(uint16_t crc, uint8_t* buffer, size_t len);
